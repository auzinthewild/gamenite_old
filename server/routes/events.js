...
router.post("/:event_id/players", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.body);
      const { event_id } = req.params;
...
router.delete("/:event_id/players", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.body);
      const { event_id } = req.params;
...
router.get("/:event_id/games", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.params);
      const { event_id } = req.params;
...
router.post("/:event_id/games", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.body);
      const { event_id } = req.params;
...
// delete a player from an event using event_id and player_id
router.delete("/:event_id/games", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.body);
      const { event_id } = req.params;
