...
router.get("/:group_id/players", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.params);
      const { group_id } = req.params;
...
router.get("/:group_id/games", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.params);
      const { group_id } = req.params;
...
router.post("/:group_id/games", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.body);
      const { group_id } = req.params;
...
router.delete("/:group_id/games", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.body);
      const { group_id } = req.params;
...
router.post("/:group_id/players", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.body);
      const { group_id } = req.params;
...
router.delete("/:group_id/players", (req, res) => {
  passport.authenticate("jwt", { session: false }, async (err, user) => {
    try {
      console.log(req.body);
      const { group_id } = req.params;
